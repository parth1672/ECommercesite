...
<link href="css/css-admin/bootstrap.css" rel="stylesheet" type="text/css" media="all">
<!-- Custom Theme files -->
<link href="css/css-admin/style.css" rel="stylesheet" type="text/css" media="all"/>
<!--js-->
<script src="js/js-admin/jquery-2.1.1.min.js"></script> 
<!--icons-css-->
<link href="css/css-admin/font-awesome.css" rel="stylesheet"> 
<!--Google Fonts-->
<link href='//fonts.googleapis.com/css?family=Carrois+Gothic' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Work+Sans:400,500,600' rel='stylesheet' type='text/css'>
<!--static chart-->
<script src="js/js-admin/js-admin/Chart.min.js"></script>
<!--//charts-->
<!-- geo chart -->
...
<!--skycons-icons-->
<script src="js/js-admin/skycons.js"></script>
<!--//skycons-icons-->
</head>
<body>	
