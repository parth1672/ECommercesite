          ...
          <div class="basket-product">
            <div class="item">
              <div class="product-image" style="height:200px; width:200px;" >
                <img src={{"/images/".$product->image}} alt="Placholder Image 2" class="product-frame" >
              </div>
              <div class="product-details" >
                <h1><strong><span class="item-quantity">1</span> x {{$product->name}}</strong> {{$product->name}} </h1>
